...
function AppHeader() {
    ...
    return (
        <nav className={"bg-gray-700 flex items-center justify-between space-x-reverse"}>
            <div>
            ...
            <div className={"items-center"}>
                <ul className={"flex"}>
                    <li className={"flex items-center text-white mx-2 font-mysans"}>
                        {user ? <span>Welcome, {user}!</span>: ""}
                    </li>
                    <li>
                        <Link to={"/login"}
                              className={"text-l font-bold flex text-white rounded-xl hover:bg-gray-600 ml-2 "}>
                            <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"
                    ...
                    {/*</li>*/}
                    <li>
                        <Link onClick={handleClick} className={"text-l font-bold flex text-white rounded-xl mr-4 ml-2"}>
                            <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"
